...
const runReleaseGate = async () => {
  ...
  const checks = [
    ...
    ['package field survey validate script', packageSource.includes('"stadium:jamsil:field-survey-validate": "node scripts/stadium-seatmap-ops.mjs jamsil field-survey-validate"')],
    ['package field survey workset script', packageSource.includes('"stadium:jamsil:field-survey-workset": "node scripts/stadium-seatmap-ops.mjs jamsil field-survey-workset"')],
    ['package food candidate validate script', packageSource.includes('"stadium:jamsil:food-candidate-validate": "node scripts/stadium-seatmap-ops.mjs jamsil food-candidate-validate"')],
    ['package food candidate review workset script', packageSource.includes('"stadium:jamsil:food-candidate-review-workset": "node scripts/stadium-seatmap-ops.mjs jamsil food-candidate-review-workset"')],
    ['package food candidate transfer script', packageSource.includes('"stadium:jamsil:food-candidate-transfer": "node scripts/stadium-seatmap-ops.mjs jamsil food-candidate-transfer"')],
    ['package food candidate apply plan script', packageSource.includes('"stadium:jamsil:food-candidate-apply-plan": "node scripts/stadium-seatmap-ops.mjs jamsil food-candidate-apply-plan"')],
    ['package restroom candidate validate script', packageSource.includes('"stadium:jamsil:restroom-candidate-validate": "node scripts/stadium-seatmap-ops.mjs jamsil restroom-candidate-validate"')],
    ['package restroom candidate review workset script', packageSource.includes('"stadium:jamsil:restroom-candidate-review-workset": "node scripts/stadium-seatmap-ops.mjs jamsil restroom-candidate-review-workset"')],
    ['package restroom candidate transfer script', packageSource.includes('"stadium:jamsil:restroom-candidate-transfer": "node scripts/stadium-seatmap-ops.mjs jamsil restroom-candidate-transfer"')],
    ['package restroom candidate apply plan script', packageSource.includes('"stadium:jamsil:restroom-candidate-apply-plan": "node scripts/stadium-seatmap-ops.mjs jamsil restroom-candidate-apply-plan"')],
    ['package operator intake script', packageSource.includes('"stadium:jamsil:operator-intake": "node scripts/stadium-seatmap-ops.mjs jamsil operator-intake"')],
    ['package operator approval script', packageSource.includes('"stadium:jamsil:operator-approval": "node scripts/stadium-seatmap-ops.mjs jamsil operator-approval"')],
    ['package operator approval status script', packageSource.includes('"stadium:jamsil:operator-approval:status": "node scripts/stadium-seatmap-ops.mjs jamsil operator-approval:status"')],
    ['package operator approval approve script', packageSource.includes('"stadium:jamsil:operator-approval:approve": "node scripts/stadium-seatmap-ops.mjs jamsil operator-approval:approve"')],
    ['package operator approval verify script', packageSource.includes('"stadium:jamsil:operator-approval:verify": "node scripts/stadium-seatmap-ops.mjs jamsil operator-approval:verify"')],
