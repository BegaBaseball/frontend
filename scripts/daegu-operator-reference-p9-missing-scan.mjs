...
async function buildPacket() {
  ...
  const payload = {
    ...
    policy: {
      ...
      note: 'P9 scans the 4096 operator reference image components and compares them with the 109 active selectable polygons. It does not add selectable seat polygons.',
    },
    summary,
    rows,
