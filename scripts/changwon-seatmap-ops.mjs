...
const runReleaseGate = async () => {
  ...
  const checks = [
    ...
    ['package mobile script', packageSource.includes('"qa:stadium:changwon:mobile": "node scripts/qa-presets.mjs stadium changwon mobile"')],
    ['package release lock script', packageSource.includes('"qa:stadium:changwon:release-lock"')],
    ['package status script', packageSource.includes('"stadium:changwon:status": "node scripts/qa-presets.mjs stadium changwon status"')],
