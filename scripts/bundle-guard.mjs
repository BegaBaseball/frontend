...
const sizeBudgets = [
  ...
  { label: 'PredictionMatchSchedule resolved data runtime', directory: clientAssetsDir, filePattern: /^PredictionMatchScheduleResolvedDataRuntime-.*\.js$/, maxBytes: 28_000 },
  ...
  { label: 'CoachBriefing shell', directory: clientAssetsDir, filePattern: /^CoachBriefing-.*\.js$/, maxBytes: 18_000 },
