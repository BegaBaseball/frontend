...
const sizeBudgets = [
  ...
  { label: 'ProfileEditSection route', directory: clientAssetsDir, filePattern: /^ProfileEditSection-.*\.js$/, maxBytes: 16_000 },
  ...
  { label: 'AccountSettingsSection route', directory: clientAssetsDir, filePattern: /^AccountSettingsSection-.*\.js$/, maxBytes: 18_000 },
  ...
  { label: 'MateCheckIn content runtime', directory: clientAssetsDir, filePattern: /^MateCheckInContentRuntime-.*\.js$/, maxBytes: 19_000 },
  ...
  { label: 'CoachBriefing shell', directory: clientAssetsDir, filePattern: /^CoachBriefing-.*\.js$/, maxBytes: 17_000 },
  ...
  { label: 'AdminAiOperations runtime', directory: clientAssetsDir, filePattern: /^AdminAiOperationsRuntime-.*\.js$/, maxBytes: 16_000 },
  { label: 'AdminAiOperations panel runtime', directory: clientAssetsDir, filePattern: /^AdminAiOperationsPanelRuntime-.*\.js$/, maxBytes: 19_000 },
  ...
  { label: 'ChatBot session runtime', directory: clientAssetsDir, filePattern: /^ChatBotSessionRuntime-.*\.js$/, maxBytes: 24_000 },
