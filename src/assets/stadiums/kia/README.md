...
3. Provide each separate aggregate polygon as points in the `2200x1159` official image coordinate system only when a new aggregate hit area is required.
