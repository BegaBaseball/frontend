      ...
      <div className="p-4 sm:p-5 flex flex-col relative z-10">
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2">
            <span className="bg-muted px-2 py-1 rounded border border-border/80 text-[15px] font-semibold text-muted-foreground">
          ...
          {statusStyle && (
            <span
              className={`inline-flex items-center rounded-full px-3 py-1 text-[15px] font-semibold border
        ...
        <div className="flex justify-center mt-5">
          {game.gameInfo ? (
            <span className="text-[15px] font-semibold text-muted-foreground px-3 py-1.5 rounded-md border border-border bg-secondary">
              {game.gameInfo}
            </span>
          ) : null}
        </div>
