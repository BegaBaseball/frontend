        ...
        <section className="space-y-4">
            ...
            <div className="grid gap-4 xl:grid-cols-[1.2fr_1fr_1.1fr]">
                <Card className="rounded-3xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                    <div className="space-y-4 p-5">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-[11px] font-black uppercase tracking-[0.18em] text-zinc-400">Active Teams</p>
                        ...
                        <div className="space-y-3">
                            {teamSummary.map(([teamName, count], index) => (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-zinc-900 text-xs font-black text-white dark:bg-white dark:text-zinc-900">
                                            {index + 1}
                                        </span>
                                        <div>
                                            <p className="text-sm font-black tracking-tight text-zinc-900 dark:text-zinc-50">{teamName}</p>
                ...
                <Card className="rounded-3xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                    <div className="space-y-4 p-5">
                        <div>
                            <p className="text-[11px] font-black uppercase tracking-[0.18em] text-zinc-400">Section Mix</p>
                ...
                <Card className="rounded-3xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                    <div className="space-y-4 p-5">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-[11px] font-black uppercase tracking-[0.18em] text-zinc-400">Headlines</p>
                        ...
                        <div className="space-y-3">
                            {headlineSummary.length > 0 ? headlineSummary.map((movement) => (
                                ...
                                >
                                    <div className="flex items-center justify-between gap-3">
                                        <div>
                                            ...
                                            <p className="mt-1 text-sm font-black tracking-tight text-zinc-900 dark:text-zinc-50">
                                ...
                                <div className="rounded-2xl border border-dashed border-zinc-200 bg-zinc-50/70 p-4 text-sm font-medium text-zinc-500 dark:border-zinc-800 dark:bg-zinc-950/60 dark:text-zinc-300">
