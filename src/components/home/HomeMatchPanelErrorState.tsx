...
const HOME_MATCH_ERROR_DESCRIPTION_CLASS = 'max-w-[32rem] px-4 text-sm font-semibold leading-5';
...
export default function HomeMatchPanelErrorState({
  ...
  return (
    <div className={HOME_MATCH_ERROR_PANEL_CLASS} style={style} {...MATCH_PRIORITY_REGION_PROPS}>
      ...
      <p className={`${HOME_MATCH_ERROR_DESCRIPTION_CLASS} ${compact
        ? 'mt-1 text-gray-500 dark:text-white'
        : 'mb-4 text-gray-400 dark:text-white'}`}
      >
        {description}
      </p>
      {suppressRecoveryActions ? (
