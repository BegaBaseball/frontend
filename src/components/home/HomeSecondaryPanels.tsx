              ...
              <section className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-100 dark:hover:bg-zinc-800/40"
                  >
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between gap-2">
                              ...
                              <p className={`inline-flex w-fit items-baseline rounded-full px-1.5 py-0.75 text-[11px] sm:text-xs font-black ring-1 ${mate.ticketPrice == null
          ...
          <div className="flex min-h-full items-center justify-center py-6">
            ...
            >
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  type="button"
                  className="rounded-md px-2 py-1 text-sm text-zinc-500 transition-colors hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-white"
                  onClick={onCloseCalendar}
                >
                  닫기
                </button>
