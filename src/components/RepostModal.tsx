        ...
        >
                          ...
                          onClick={() => {
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    ...
                                    <p className="text-body font-semibold text-red-500/70 dark:text-red-400/70">
                                        내 프로필에서 제거됩니다
                                    </p>
                                </div>
                            </button>
                                ...
                                <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-card mx-auto mb-3 flex items-center justify-center">
                                    <RepeatIcon className="w-6 h-6 text-gray-400" />
                                        ...
                                        <p className="text-body font-semibold text-gray-500 dark:text-white">
                        ...
                        <>
                            ...
                            >
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center ${isRepostedByMe
                                        ...
                                        {isRepostedByMe ? (
                                            ...
                                            <RepeatIcon className="w-5 h-5 text-gray-600 dark:text-white" />
                                        )}
                                    </div>
                                    <div className="flex-1 text-left">
                            ...
                            >
                                    <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-card flex items-center justify-center">
                                        <QuoteIcon className="w-5 h-5 text-gray-600 dark:text-white" />
                                    </div>
                                    <div className="flex-1 text-left">
                ...
                <div className="px-4 py-3 border-t border-gray-100 dark:border-border">
                    <button
                        type="button"
                        onClick={onClose}
                        className="w-full py-2.5 text-body font-semibold text-gray-500 dark:text-white hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
                    >
                        취소
                    </button>
                </div>
