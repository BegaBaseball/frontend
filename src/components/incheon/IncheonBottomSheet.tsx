...
export default function IncheonBottomSheet({ section, mode, onClose, onUpload }: BottomSheetProps) {
      ...
      <div className="flex shrink-0 items-center gap-3 px-4 pb-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-1.5 text-[11px] text-slate-500">
            {cat.label} · {getIncheonSideLabel(section.side)} · {getIncheonFanRoleLabel(section.fanRole)}
          </div>
        </div>
        <button
          type="button"
      ...
      >
        ...
        <div className="mb-4 grid grid-cols-2 gap-2">
          ...
          <div className="rounded-xl bg-slate-50 p-2.5 dark:bg-slate-800">
            ...
            <div className="mt-0.5 text-sm font-black text-slate-800 dark:text-white">{getIncheonSideLabel(section.side)}</div>
          </div>
          <div className="rounded-xl bg-slate-50 p-2.5 dark:bg-slate-800">
            <div className="text-[9px] font-bold tracking-widest text-slate-400">팬 구분</div>
            <div className="mt-0.5 text-sm font-black text-slate-800 dark:text-white">{getIncheonFanRoleLabel(section.fanRole)}</div>
          </div>
          <div className="rounded-xl bg-slate-50 p-2.5 dark:bg-slate-800">
