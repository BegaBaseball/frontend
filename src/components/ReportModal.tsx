    ...
    return (
        ...
        >
            ...
            <div className="grid gap-4 py-4">
                <fieldset>
                    <legend className="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">신고 사유 선택</legend>
                    <div className="grid gap-3" aria-label="신고 사유">
                        {Object.entries(ReportReasonLabels).map(([key, label]) => (
                            <label key={key} htmlFor={`r-${key}`} className="flex items-center space-x-2 text-sm text-gray-700 dark:text-gray-300">
                                <input
                                    id={`r-${key}`}
                                    type="radio"
                                    name="report-reason"
                ...
                <div className="grid gap-2">
                    <label htmlFor="description" className="text-sm font-medium text-gray-700 dark:text-gray-300">추가 설명 (선택)</label>
                    <Textarea
                        id="description"
                ...
                <div className="grid gap-2">
                    <label htmlFor="sourceUrl" className="text-sm font-medium text-gray-700 dark:text-gray-300">원문 URL (선택)</label>
                    <Textarea
                        id="sourceUrl"
                ...
                <div className="grid gap-2">
                    <label htmlFor="ownerContact" className="text-sm font-medium text-gray-700 dark:text-gray-300">권리자/대리인 연락처 (선택)</label>
                    <Textarea
                        id="ownerContact"
                ...
                <div className="grid gap-2">
                    <label htmlFor="license" className="text-sm font-medium text-gray-700 dark:text-gray-300">라이선스 정보 (선택)</label>
                    <Textarea
                        id="license"
                ...
                <div className="grid gap-2">
                    <label htmlFor="evidenceUrl" className="text-sm font-medium text-gray-700 dark:text-gray-300">증빙 링크 (선택)</label>
                    <Textarea
                        id="evidenceUrl"
                ...
                <div className="grid gap-2">
                    <label htmlFor="requestedAction" className="text-sm font-medium text-gray-700 dark:text-gray-300">요청 조치 (선택)</label>
                    <Textarea
                        id="requestedAction"
