    ...
    >
      <div className="p-4 md:p-5 space-y-3.5 relative z-10">
        ...
        <div className="flex items-center justify-between gap-2">
          <span className="inline-flex items-center gap-1.5 rounded-lg border border-emerald-200 bg-emerald-50/90 px-2.5 py-1 text-sm font-bold text-emerald-800 dark:border-emerald-700/60 dark:bg-emerald-900/30 dark:text-emerald-200 shadow-sm">
        ...
        <div className="space-y-1.5">
          <div className="flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center gap-1 text-xs font-medium text-slate-600 dark:text-slate-200 bg-slate-100 dark:bg-secondary px-2 py-0.5 rounded-md border border-slate-200/80 dark:border-white/10">
          ...
          <div className="text-xs text-gray-600 dark:text-gray-200 leading-relaxed">
            ...
            <p className="text-slate-500 dark:text-slate-300">선발 발표 전</p>
          </div>
        </div>

        <Button
          onClick={handleButtonClick}
          className="w-full h-9 text-xs font-bold bg-primary hover:bg-primary/90 text-white rounded-xl shadow-sm"
        >
          승부예측 하러가기
