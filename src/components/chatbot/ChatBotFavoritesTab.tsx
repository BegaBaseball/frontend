            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <p className="m-0 truncate text-[16px] font-semibold text-gray-900 dark:text-white">{favorite.sessionTitle}</p>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className={`rounded-xl px-3 py-2 text-[16px] font-semibold transition-colors ${
                    favorite.prompt
