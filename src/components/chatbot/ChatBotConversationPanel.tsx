    ...
    >
      {message.sender === 'bot' ? (
        <div className="group relative max-w-[85%]">
          ...
          >
            <DeferredMarkdown
              ...
              fallbackClassName="whitespace-pre-wrap break-words text-[15px]"
              content={
                isStreamError
            ...
            <div className="mt-1 flex flex-wrap items-center gap-1.5">
              ...
              <p className="m-0 text-[15px] text-gray-500 dark:text-gray-300">
          ...
          {message.strategy === 'llm_knowledge_db_unavailable' && (
            <div className="mt-1.5 rounded-xl border border-orange-200 bg-orange-50 px-3 py-2 text-[15px] text-orange-700 dark:border-orange-700/40 dark:bg-orange-900/20 dark:text-orange-300">
            ...
            return (
              <div className="mt-1.5 ml-1">
                <button
                  ...
                  className="flex items-center gap-1 text-[15px] font-semibold text-gray-400 transition-colors hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300"
                >
                  <ChevronDown
                ...
                {isExpanded && (
                  <ul className="m-0 mt-1 list-none space-y-0.5 p-0">
                    {visibleTools.map((toolCall, toolIndex) => {
                      ...
                      <li
                        key={toolIndex}
                          className="flex items-start gap-1 text-[15px] text-gray-500 dark:text-gray-400"
                      >
        ...
        <div className="max-w-[85%] rounded-2xl bg-primary py-2.5 px-4 text-white">
          <p className="m-0 text-[15px]">{message.text}</p>
    ...
    <div className="flex min-h-0 flex-1 flex-col">
          ...
          <>
            ...
            {isTyping && (
              <div className="flex justify-start">
                <div
                  className="chatbot-typing-text text-[15px] leading-6 text-zinc-500 dark:text-zinc-300"
                  aria-live="polite"
                >
                  <span className="chatbot-baseball mr-1 inline-flex h-4 w-4 items-center justify-center align-top text-[15px]">
                    ⚾
                  </span>
      ...
      <div className="border-t border-gray-200 bg-gray-50/90 px-4 py-2 dark:border-white/10 dark:bg-black/20">
          <button
            ...
            className="flex w-full items-center gap-1.5 text-[15px] font-semibold text-muted-foreground transition-colors hover:text-primary"
        >
      ...
      >
        ...
        >
          ...
          <input
            ...
            inputMode="text"
            autoComplete="off"
            className="flex-1 border-none bg-transparent px-1 py-2 text-[15px] text-gray-900 outline-none placeholder:text-gray-400 dark:text-white dark:placeholder:text-gray-500"
          />
          {isProcessing && (
            <button
              type="button"
        ...
        {rateLimitActive && rateLimitCopy && (
          <div
            ...
            aria-atomic="true"
            role="status"
            className="mt-2 rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-[15px] text-amber-900 dark:border-amber-400/30 dark:bg-amber-400/10 dark:text-amber-100"
          >
            ...
            <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className={`
                    rounded-lg px-3 py-1 text-[15px] font-semibold transition-colors
                    ${
                ...
                <button
                  ...
                  className={`
                    rounded-lg border border-amber-200 px-3 py-1 text-[15px] font-semibold transition-colors
                    ${
