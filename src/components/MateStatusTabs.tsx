...
export default function MateStatusTabs({
  ...
  return (
    <div role="group" aria-label="파티 상태 필터" className="relative inline-flex w-full justify-start gap-1 rounded-xl border border-gray-200/80 bg-white p-1 dark:border-white/15 dark:bg-[#000000] md:w-fit">
      {MATE_TABS.map((tab) => {
        ...
        return (
          <button
            ...
            className={`relative h-8 min-w-0 flex-1 rounded-lg px-2 text-13 font-bold transition-colors duration-150 focus-visible:z-20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/80 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-[#000000] sm:px-3.5 md:flex-none ${
              isActive
