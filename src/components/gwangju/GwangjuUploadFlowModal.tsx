...
import { GWANGJU_CATEGORIES, type GwangjuBlock } from '../../data/gwangjuSeatData';
...
export default function GwangjuUploadFlowModal({ section, mode, onClose, onSubmit }: Props) {
