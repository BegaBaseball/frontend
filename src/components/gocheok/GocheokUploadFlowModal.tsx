...
import { GOCHEOK_CATEGORIES, type GocheokBlock } from '../../data/gocheokSeatData';
...
export default function GocheokUploadFlowModal({ section, mode, onClose, onSubmit }: Props) {
      ...
      >
        <div className="border-b border-slate-100 px-6 pb-4 pt-5 dark:border-slate-800">
          <div className="flex items-start justify-between gap-4">
            <div>
              <div className="mb-1 text-[11px] font-black uppercase tracking-widest text-slate-400">GOCHEOK SEAT VIEW</div>
