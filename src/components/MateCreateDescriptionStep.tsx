        ...
        <div className="flex flex-wrap gap-2 mt-2">
          {STYLE_TAGS.map((tag) => (
            <button
              type="button"
              key={tag}
              className="text-body px-2 py-1 bg-gray-100 dark:bg-card rounded-md text-gray-600 dark:text-white hover:bg-primary/10 dark:hover:bg-primary/30 hover:text-primary transition-colors"
              onClick={() => {
