        ...
        <div className="rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-emerald-500/10 via-slate-900 to-slate-900 p-5 shadow-lg shadow-emerald-500/10">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-3">
            <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Visible Rows</p>
              <p className="mt-2 text-3xl font-black tracking-tight text-white">{filteredMovements.length}</p>
              <p className="mt-1 text-sm text-slate-500">원본 조회 결과 {movements.length}건</p>
            </div>
            <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Summary Filled</p>
              <p className="mt-2 text-3xl font-black tracking-tight text-emerald-300">{summaryCount}</p>
              <p className="mt-1 text-sm text-slate-500">미입력 {qualityCounts.MISSING_SUMMARY}건</p>
            </div>
            <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Source Linked</p>
              <p className="mt-2 text-3xl font-black tracking-tight text-sky-300">{sourcedCount}</p>
              <p className="mt-1 text-sm text-slate-500">미입력 {qualityCounts.MISSING_SOURCE}건</p>
            </div>
          </div>
        </div>

        <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-5">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Structured Coverage</p>
          <div className="mt-4 space-y-3">
            <div className="rounded-2xl border border-slate-800 bg-slate-950/80 p-4">
              ...
              <p className="mt-1 text-sm text-slate-500">계약 기간, 금액, 옵션, 상대 구단, 반대급부 중 1개 이상</p>
            </div>
            <div className="rounded-2xl border border-slate-800 bg-slate-950/80 p-4">
              ...
              <p className="mt-2 text-sm text-slate-500">상세 메모 입력 {detailsCount}건 · 미입력 {qualityCounts.MISSING_DETAILS}건</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-5">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">{activeQualityOption.hint}</p>
          </div>
