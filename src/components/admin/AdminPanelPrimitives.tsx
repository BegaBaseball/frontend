...
export const adminNativeSelectClassName =
  'w-full rounded-xl border border-slate-700 bg-slate-800/50 px-3 py-2 text-caption font-medium text-slate-200 focus:border-violet-500 focus:outline-none focus:ring-1 focus:ring-violet-500 disabled:cursor-not-allowed disabled:opacity-60';
