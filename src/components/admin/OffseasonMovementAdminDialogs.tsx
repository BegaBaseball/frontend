        ...
        <div className="grid gap-6">
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">이동 날짜</p>
              <Input
                type="date"
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">구분</p>
              <select
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">팀 코드</p>
              <select
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">선수명</p>
              <Input
          ...
          <div className="grid gap-4 xl:grid-cols-[1.1fr_1.1fr_0.9fr]">
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">요약</p>
              <Textarea
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">상세 메모</p>
              <Textarea
            ...
            <div className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
              <div className="space-y-2">
                <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">계약 기간</p>
                <Input
              ...
              <div className="space-y-2">
                <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">계약 규모</p>
                <Input
              ...
              <div className="space-y-2">
                <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">옵션</p>
                <Input
          ...
          <div className="grid gap-4 xl:grid-cols-[0.8fr_1.2fr_0.8fr_1fr]">
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">상대 구단</p>
              <select
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">반대급부</p>
              <Input
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">출처명</p>
              <Input
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">발표 시각</p>
              <Input
                type="datetime-local"
          ...
          <div className="grid gap-4 xl:grid-cols-[1.2fr_1.8fr]">
            <div className="space-y-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">출처 URL</p>
              <Input
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">미리보기</p>
