    ...
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
          ...
          <div className="space-y-2 text-sm text-slate-300">
            <p className="font-mono text-sm text-slate-500">{selectedEvent.event.eventId}</p>
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
          ...
          <pre className="max-h-[280px] overflow-auto rounded-xl bg-slate-950/80 p-4 text-sm text-slate-200">
          ...
          {selectedEvent.sameFingerprintRecentEvents.length ? selectedEvent.sameFingerprintRecentEvents.map((item) => (
            ...
            >
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-sm text-slate-500">{formatDetailedDateTime(item.occurredAt)}</span>
              </div>
