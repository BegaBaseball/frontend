...
const selectClassName = 'w-full rounded-lg border border-slate-700 bg-slate-800/50 px-3 py-2 text-slate-200 focus:border-violet-500 focus:outline-none focus:ring-1 focus:ring-violet-500';
