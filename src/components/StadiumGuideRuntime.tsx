        ...
        {stadiumsStatus === 'error' && stadiumsError && (
          <div className="bg-red-50 border border-red-200 text-red-700 dark:bg-red-900/20 dark:border-red-800 dark:text-red-400 px-4 py-3 rounded-lg mb-4 flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[15px]">{stadiumsError}</span>
            </div>
            <Button
              size="sm"
              variant="outline"
            ...
            <div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-[15px] text-gray-600 dark:text-gray-300 mb-1">
                          📍 {selectedStadiumAddress}
                        </p>
                      )}
                      {selectedStadiumPhone && (
                        <p className="text-[15px] text-gray-600 dark:text-gray-300">📞 {selectedStadiumPhone}</p>
                      )}
                      {!hasStadiumCoordinates && (
                        <p className="text-[15px] text-amber-700 dark:text-amber-400 mt-2">
              ...
              {canRenderMap ? (
                ...
                >
                  ...
                  <p className="text-[15px] text-gray-500 dark:text-gray-300 mt-4">
                    {!selectedStadium
                      ? '구장을 선택하면 지도를 표시합니다.'
                      : !KAKAO_API_KEY
                        ? '카카오맵 API 키를 설정해주세요.'
                  ...
                  return (
                    ...
                    >
                      <Icon className="w-6 h-6" />
                        <span className="text-[15px]" style={{ fontWeight: isSelected ? 700 : 400 }}>
                        {config.label}
                      </span>
                    </button>
                  );
              ...
              <div className="flex gap-2 mb-3">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-9 h-9 text-[15px] dark:bg-card dark:border-border"
                  />
                </div>
                <div className="relative">
                  ...
                  <select
                    ...
                    disabled={listControlsDisabled}
                    className="stadium-guide-select h-9 pl-8 pr-3 text-[15px] rounded-md border border-input bg-background dark:bg-card dark:border-border dark:text-gray-200 cursor-pointer"
                  >
                            ...
                            >
                              <div className="flex items-center justify-between">
                                ...
                                >
                                  ...
                                  {placeDescription && (
                                    <p className="text-gray-600 dark:text-gray-300 text-[15px] mb-1">
                                      {placeDescription}
                                    </p>
                                  )}
                                  {placeAddress && (
                                    <p className="text-[15px] text-gray-600 dark:text-gray-300">📍 {placeAddress}</p>
                                  )}
                                  {placePhone && (
                                    <p className="text-[15px] text-gray-600 dark:text-gray-300">📞 {placePhone}</p>
                                  )}
                                  {(placeOpenTime || placeCloseTime) && (
                                    ...
                                    {!hasPlaceCoordinates && (
                                    <p className="text-[15px] text-amber-700 dark:text-amber-400 mt-1">
