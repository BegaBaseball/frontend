...
const CREATIVE_STYLES: Record<AdCreativeType, string> = {
  native_card: 'rounded-[20px] border border-slate-200/80 bg-white px-4 py-3 shadow-sm dark:border-white/10 dark:bg-[#16181c]',
  sponsor_card: 'rounded-[20px] border border-slate-200/80 bg-white px-4 py-3 shadow-sm dark:border-white/10 dark:bg-[#16181c]',
  banner: 'rounded-[20px] border border-slate-200/80 bg-white px-4 py-3 shadow-sm dark:border-white/10 dark:bg-[#16181c]',
};
...
export default function AdSlot({
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center justify-between gap-2 text-[15px] font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">
        <span>광고</span>
        <span>{slotId}</span>
      </div>
