          ...
          <div className="grid gap-3 pt-2">
            {matchLoadErrorMessage && (
              <div className="flex items-center justify-between gap-2">
                <p className="text-body text-red-500">{matchLoadErrorMessage}</p>
                  ...
                  >
                    <div className="relative z-10 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex flex-col gap-3 sm:flex-1 sm:flex-row sm:items-center sm:gap-4">
                        <div className="w-full text-left text-body font-bold text-gray-500 dark:text-white sm:w-16 sm:text-center">
                          {match.gameTime}
                        </div>
                      ...
                      <div className="min-w-0 text-left text-body text-gray-400 sm:ml-4 sm:min-w-[60px] sm:text-right">
