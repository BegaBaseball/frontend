    ...
    if (isError) {
        return (
            <div className="bg-red-50/50 dark:bg-card rounded-2xl p-5 border border-red-100 dark:border-border">
                ...
                <p className="text-[16px] text-[#64748B] dark:text-white">데이터를 불러오지 못했습니다.</p>
                <p className="mt-1 text-[16px] text-slate-500 dark:text-white">
    ...
    if (!hotPosts.length) {
        return (
            <div className="bg-red-50/50 dark:bg-card rounded-2xl p-5 border border-red-100 dark:border-border">
                ...
                <p className="text-[16px] text-[#64748B] dark:text-white">지금은 표시할 인기 글이 없습니다.</p>
            </div>
        );
    }
