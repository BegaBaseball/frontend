    ...
    return (
        <div className="flex w-full flex-col gap-4">
            <div className="rounded-2xl border border-border/70 bg-white p-4 dark:border-border dark:bg-card">
                ...
                {teamId === 'all' ? (
                    <p className="mt-3 text-sm leading-relaxed text-[#64748B] dark:text-gray-300">
                    ...
                    <div className="mt-3 rounded-xl bg-red-50 px-3 py-3 text-sm text-[#64748B] dark:bg-secondary/70 dark:text-gray-300">
                        ...
                        <button
                            ...
                            className="mt-3 w-full rounded-full border border-red-200 px-3 py-2 text-xs font-semibold text-red-600 hover:bg-red-100 dark:border-border dark:text-red-300 dark:hover:bg-secondary"
                        >
                            다시 시도
                        </button>
                    </div>
                ) : (
                    <p className="mt-3 text-sm leading-relaxed text-[#64748B] dark:text-gray-300">{teamDescription}</p>
                )}
            </div>
            ...
            <div className="rounded-2xl border border-border/70 bg-white p-4 dark:border-border dark:bg-card">
                ...
                {isGamesLoading ? (
                    ...
                    <div className="mt-3 rounded-xl bg-slate-50 px-3 py-3 text-sm text-[#64748B] dark:bg-secondary/70 dark:text-gray-300">
                        경기 정보를 불러오지 못했습니다.
                        <button
                            type="button"
                            onClick={onRefetchGames}
                            className="mt-3 w-full rounded-full border border-slate-200 py-2 text-xs font-semibold text-slate-600 hover:bg-slate-50 dark:border-border dark:text-gray-200 dark:hover:bg-secondary"
                        >
                            다시 시도
                        </button>
                    </div>
                    ...
                    <div className="mt-3 space-y-3">
                        ...
                        <button
                            type="button"
                            className="w-full rounded-full border border-slate-200 py-2 text-sm font-semibold text-[#0F172A] hover:bg-slate-50 dark:border-border dark:text-white dark:hover:bg-secondary"
