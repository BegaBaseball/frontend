...
export default function CheerSidebarPanels({
    ...
    return (
        <div className="flex w-full flex-col gap-4">
                    ...
                    <div className="mt-3 space-y-2">
                        ...
                        <button
                            ...
                            onClick={onRefetchTeamMetadata}
                                className="mt-3 w-full rounded-full border border-red-200 px-3 py-2 text-[16px] font-bold text-red-600 hover:bg-red-100 dark:border-border dark:text-red-300 dark:hover:bg-secondary"
                        >
                            다시 시도
                        </button>
                    </div>
            ...
            <div className="rounded-2xl border border-border/70 bg-white p-4 dark:border-border dark:bg-card">
                    <p className="text-[16px] font-bold text-[#0F172A] dark:text-white">오늘 경기</p>
                {isGamesLoading ? (
                    ...
                    <div className="mt-3 space-y-3">
                        ...
                        <div className="rounded-xl border border-slate-100 px-3 py-3 dark:border-border">
                            <div className="flex items-center justify-between gap-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[16px] font-bold text-[#0F172A] dark:text-white">
                                        {featuredGame.awayTeam}
                                    </span>
                                </div>
                                    <span className="text-[16px] font-bold text-slate-400">vs</span>
                                <div className="flex items-center gap-2">
                        ...
                        <button
                            type="button"
                            className="w-full rounded-full border border-slate-200 py-2 text-[16px] font-bold text-[#0F172A] hover:bg-slate-50 dark:border-border dark:text-white dark:hover:bg-secondary"
