...
export const SUWON_SEATMAP_IMAGE = {
  imagePath: 'src/assets/stadiums/kt/suwon-kt-seatmap-official-2026@2x.jpg',
  imageWidth: 4290,
  imageHeight: 9679,
  ...
  requiredAssetFileName: 'suwon-kt-seatmap-official-2026@2x.jpg',
  requiredAssetPath: 'src/assets/stadiums/kt/suwon-kt-seatmap-official-2026@2x.jpg',
};
...
const officialImageGeometries: Record<string, GeometryDraft> = {
  ...
  'suwon-231': polygonGeometry('231', [[972,2776],[1068,2712],[1108,2784],[1013,2849]], 1040, 2780, -35, 54),
  'suwon-232': polygonGeometry('232', [[937,2686],[1033,2622],[1073,2694],[978,2759]], 1005, 2690, -35, 54),
  'suwon-233': polygonGeometry('233', [[862,2596],[958,2532],[998,2604],[903,2669]], 930, 2600, -35, 54),
...
export const SUWON_ALIGNMENT_PROBES = deepFreeze([
  ...
  probeFromBlock('suwon-229', '2층 3루 응원지정석 대표 구역'),
