...
const SAJIK_BLOCK_DEFINITIONS: SajikBlockDefinition[] = [
  ...
  },
  {
    ...
    displayPriority: 48,
    imageGeometry: {
      d: 'M 500 439 L 506 433 L 508 434 L 512 437 L 533 451 L 535 453 L 535 454 L 532 457 L 531 459 L 528 459 L 521 455 L 516 452 L 504 444 L 500 441 Z',
      labelX: 525,
      labelY: 455,
      labelRotate: 13,
      labelFontSize: 9,
  ...
  },
  {
    ...
    displayPriority: 49,
    imageGeometry: {
      d: 'M 574 466 L 604 469 L 605 474 L 602 491 L 571 488 L 572 474 Z',
  ...
  },
  {
    ...
    displayPriority: 72,
    imageGeometry: {
      d: 'M 772 464 L 779 460 L 790 454 L 792 453 L 793 453 L 803 454 L 803 456 L 798 459 L 791 463 L 778 470 L 775 470 L 772 466 Z',
      labelX: 787,
      labelY: 460,
      labelRotate: -12,
      labelFontSize: 9,
  ...
  },
  {
    ...
    displayPriority: 79,
    imageGeometry: {
      d: 'M 779 473 L 805 459 L 807 458 L 808 460 L 807 463 L 814 463 L 814 464 L 812 466 L 798 475 L 787 482 L 786 482 L 779 475 Z',
      labelX: 795,
      labelY: 471,
      labelRotate: -14,
      labelFontSize: 9,
...
export const SAJIK_OFFICIAL_TRACE_REFERENCE: Record<string, SajikOfficialTraceReference> = {
  ...
  '033': { numberAnchor: { x: 525, y: 455 }, expectedBounds: { minX: 500, minY: 433, maxX: 535, maxY: 459 }, expectedSubpathCount: 1, expectedPointCount: 14, expectedArea: 361 },
  '032': { numberAnchor: { x: 588, y: 480 }, expectedBounds: { minX: 571, minY: 466, maxX: 605, maxY: 491 }, expectedSubpathCount: 1, expectedPointCount: 6, expectedArea: 704.5 },
  ...
  '133': { numberAnchor: { x: 787, y: 460 }, expectedBounds: { minX: 772, minY: 453, maxX: 803, maxY: 470 }, expectedSubpathCount: 1, expectedPointCount: 12, expectedArea: 237 },
  ...
  '143': { numberAnchor: { x: 795, y: 471 }, expectedBounds: { minX: 779, minY: 458, maxX: 814, maxY: 482 }, expectedSubpathCount: 1, expectedPointCount: 12, expectedArea: 340.5 },
